...
public class ServletDetallePedido extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<DetallePedidoBeans> listaDetallePedido = detallePedidoDao.listarPorIdPedido(idPedido);
        
        for(DetallePedidoBeans detallePedidoBeans :listaDetallePedido){
            ProductosBeans productosBeans = productoDao.listarPorId(detallePedidoBeans.getIdProducto());
            detallePedidoBeans.setNombreProducto(productosBeans.getNombre());
        }
        request.setAttribute("listaDetallePedido", listaDetallePedido);
        request.getRequestDispatcher("misdetallespedidos.jsp").forward(request, response);
